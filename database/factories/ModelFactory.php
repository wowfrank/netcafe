...
$factory->define(Netcafe\User::class, function (Faker\Generator $faker) {
    return [
        'name' => $faker->name,
        'email' => $faker->email,
...
$factory->define(Netcafe\Models\Posts::class, function ($faker) {
...
$factory->define(Netcafe\Models\Tag::class, function ($faker) {
    $images = ['about-bg.jpg', 'contact-bg.jpg', 'home-bg.jpg', 'post-bg.jpg'];
    $word = $faker->word;
