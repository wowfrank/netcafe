...
<div class="form-group">
	<label for="meta_description" class="col-md-3 control-label"> {{ trans('messages.Meta Description') }} </label>
	<div class="col-md-8">
...
<div class="form-group">
	<label for="page_image" class="col-md-3 control-label"> {{ trans('messages.Page Image') }} </label>
	<div class="col-md-8">
...
<div class="form-group">
	<label for="reverse_direction" class="col-md-3 control-label"> {{ trans('messages.Direction') }} </label>
	<div class="col-md-7">
