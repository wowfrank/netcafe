...
<div class="container-fluid">
	<div class="row page-title-row">
		<div class="col-md-12">
			<h3>{{ trans('messages.Tags') }} <small>» {{ trans('messages.Edit Tag') }}</small></h3>
		</div>
	</div>
		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">{{ trans('messages.Tag Edit Form') }}</h3>
				</div>
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="/admin/tag/{{ $id }}">
						...
						<div class="form-group">
							<label for="tag" class="col-md-3 control-label">{{ trans('messages.Tag') }}</label>
							<div class="col-md-3">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="lead">
					...
					{{ trans('messages.Are you sure you want to delete the') }} {{ trans('messages.tag') }}?
				</p>
			</div>
